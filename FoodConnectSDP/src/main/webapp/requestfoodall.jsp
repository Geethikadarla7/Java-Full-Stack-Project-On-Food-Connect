    ...
    <div class="table-container">
        <table>
            <tr>
                ...
                <th>Surplus Category</th>
                <th>Pick-Up Location</th>
                <th>Surplus Description</th>
                <th>Expiry Date</th>
                <th>Email</th>
                <th>Contact</th>
                <th>Request Surplus</th>
            </tr>
            ...
            <c:forEach items="${donationlist}" var="donation">
                <tr>
                    ...
                    <td>
                    <a class="update-btn" href='<c:out value="updatedonat"></c:out>'>Request</a>
                </tr>
            </c:forEach>
        </table>
    </div>
