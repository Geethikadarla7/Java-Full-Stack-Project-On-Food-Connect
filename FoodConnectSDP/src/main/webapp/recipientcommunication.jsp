    ...
    <section class="home">
        <div class="form-container">
            <form action="thankyou.jsp" method="post">
                <h2>Recieve Surplus Updates</h2>

                <div class="form-group">
                    <label for="recipient-org"> Organization Name</label>
                    <input type="text" id="recipient-org" name="recipient-org" value="" placeholder="Your Organization Name" required>
                </div>

                <div class="form-group">
                    <label for="contact-person">Contact Person</label>
                    <input type="text" id="contact-person" name="contact-person" placeholder="Your Full Name" required>
                </div>
                ...
                <div class="form-group">
                    <label for="donation-id">Surplus ID (if known)</label>
                ...
                <div class="form-group"> 
                    ...
                    <select id="update-type" name="update-type" required>
                        ...
                        <option value="confirm">Confirm Surplus availability</option>
                        <option value="quantity">Update Surplus quantity</option>
