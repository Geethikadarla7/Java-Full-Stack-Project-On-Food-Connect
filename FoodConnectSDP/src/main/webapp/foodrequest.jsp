...
<body>
    ...
    <section class="home">
        ...
        <div class="form-container">
            <form action="recipientdashboard.jsp">
                <h2>Surplus Request Form</h2>
               
                <div class="form-group">
                    <label for="name">Organization Name</label>
                    <input type="text" id="name">
                    <label for="phone-number">Phone Number</label>
                    <input type="number" id="phone-number" placeholder="798128398383">
                ...
                <div class="form-group">
                    ...
                    <label for="food-category">Surplus Category</label>
                ...
                <label for="quantity">Quantity (kg):</label>
                 ...
                 <label for="foodCondition">Surplus Condition:</label>
                ...
                <option value="frozen">Frozen</option>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" id="pickup-location" placeholder="Address where food can be picked up">
                </div>
                <div class="form-group">
                    <label for="neededByDate">Surplus Needed By (Date):</label>
                ...
                <div class="submit-btn">
                    <input type="submit" value="Submit Surplus Request">
                </div>
            </form>
        </div>
    </section>
