...
<c:forEach items="${reciplist}"  var="recipient">
 ...
 <td><c:out value="${recipient.status}"></c:out>
   <td>
   <a href='<c:url value="updaterstatus?regno=${recipient.regno}&status=Accepted"></c:url>' class="action-link accept">&#10004;</a>
    <a href='<c:url value="updaterstatus?regno=${recipient.regno}&status=Rejected"></c:url>' class="action-link reject">&#10060;</a>
    </td>
